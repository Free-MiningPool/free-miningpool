...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Free Mining Pool</title>
  </head>
  <body>

    <nav class="navbar navbar-expand-lg navbar-light mb-5">
      <div class="container">
        <div class="col-3 p-0 align-middle">
          <a class="navbar-brand align-middle" href="#"><img class="logo mx-auto d-block float-left" src="images/Freepool.png" alt="logo"></a><a class="navbar-brand" href="#">Free Mining Pool</a>
        </div>
        <div class="col-9 justify-content">
    ...
    <div class="container">
      ...
      <div class="pools-title container mb-4 p-1">
        <h2 class="pools-h2 text-left mb-0">Our Pools</h2>
      </div>
